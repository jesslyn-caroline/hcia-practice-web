...
function LoginCard() {
    ...
    const { studentID, password, handleStudentIDchange, handlePasswordChange, login } = useContext(UserContext)
            ...
            <div className={`max-w-[400px] w-full h-fit border rounded-xl border-greyist py-8 px-6 lg:px-10 flex flex-col items-center`}>
                ...
                <div className={`w-full mt-10 flex flex-col space-y-8`}>
                    <div className={`w-full text-sm text-text `}>
                        ...
                        <input type="text" value={studentID} onChange={handleStudentIDchange} className={`w-full h-10 outline-none border-b-2 border-text`} id="studentID" placeholder="Enter your Student ID"></input>
                    </div>
                    <div className={`w-full text-sm text-text `}>
                        <label className={`font-medium`}>Password</label>
                        <input type="password" value={password} onChange={handlePasswordChange} className={`w-full h-10 outline-none border-b-2 border-text`} id="password" placeholder="Enter your password"></input>
                    </div>
