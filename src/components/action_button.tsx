...
function ActionButton({action, text, icon, isOnLoad} : Props) {
    return (
        <button className={`h-fit bg-primary px-4 py-2 rounded-md text-white relative flex justify-center cursor-pointer hover:bg-[#AF0009] transition-all`} onClick={action}>
