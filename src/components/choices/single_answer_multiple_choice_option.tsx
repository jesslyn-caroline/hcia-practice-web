...
function SingleAnswerMultipleChoiceOption({options, id, isOptionsSelected, handleIsOptionsSelectedChange} : Props) {
...
export default SingleAnswerMultipleChoiceOption